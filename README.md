...
AI tools (e.g., ChatGPT) were used during the development of this project for:
...
All design documents (SRS, DDS, WBS, datasets.md) and all code in this repository were written by me in my own words.  
No text or code generated by AI tools was copied directly into the final submission.

This submission reflects my own understanding and implementation of the project.
